...
class CFieldsCountry
{
	...
	function getFieldHTML( $field , $required )
	{
		...
		ob_start();
?>
	<select id="field<?php echo $field->id;?>" name="field<?php echo $field->id;?>" class="hasTip tipRight select validate-country<?php echo $class;?> inputbox" title="<?php echo JText::_($field->name) . '::'. cEscape( JText::_($field->tips) );?>">
		<option value=""<?php echo empty($field->value) ? ' selected="selected"' : ''; ?>><?php echo JText::_('SELECT A COUNTRY');?></option>
