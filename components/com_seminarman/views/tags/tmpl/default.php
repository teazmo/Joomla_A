...
<p class="buttons"><?php echo seminarman_html::favouritesbutton($this->params) . seminarman_html::printbutton($this->print_link, $this->params) . seminarman_html::mailbutton('tags', $this->params, $this->tag->slug); ?></p>
