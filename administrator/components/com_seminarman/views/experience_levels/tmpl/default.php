...
JToolBarHelper::title(JText::_('COM_SEMINARMAN_EXPERIENCE_LEVELS'), 'generic.png');
...
for ($i = 0, $n = count($this->courses); $i < $n; $i++)
{
    ...
    $link = JRoute::_('index.php?option=com_seminarman&controller=experience_level&task=edit&cid[]=' .
        $row->id);
...
?>
   ...
   <input type="hidden" name="view" value="experience_levels" />
