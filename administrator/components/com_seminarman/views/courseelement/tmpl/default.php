...
<form action="index.php?option=com_seminarman&amp;view=courseelement&amp;tmpl=component" method="post" name="adminForm" id="adminForm">
...
?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td class="<?php echo $this->direction ? 'left' : 'right'; ?>">
					<a style="cursor:pointer" onclick="window.parent.qfSelectCourse('<?php echo $row->id; ?>', '<?php echo str_replace(array("'", "\""), array("\\'", ""), $row->title); ?>');">
