...
JToolBarHelper::title(JText::_('COM_SEMINARMAN_COMPANY_TYPE') . ': <span class="small">[ ' . $text . ' ]</span>');
	...
	<fieldset class="adminform">
		<ul class="adminformlist">
			...
			<li>
				...
				<input class="inputbox required" type="text" name="title" id="title" size="32" maxlength="100" value="<?php echo $this->escape($this->company_type->title); ?>" />
			</li>
			<li>
				<label for="alias"><?php echo JText::_('COM_SEMINARMAN_ALIAS'); ?></label>
				<input class="inputbox" type="text" name="alias" id="alias" size="32" maxlength="100" value="<?php echo $this->company_type->alias; ?>" />
			</li>
			<li>
				<label for="code"><?php echo JText::_('COM_SEMINARMAN_CODE'); ?></label>
				<input class="inputbox" type="text" name="code" id="code" size="3" maxlength="2" value="<?php echo $this->company_type->code; ?>" />
			</li>
			<li>
		...
		<textarea class="text_area" cols="44" rows="12" name="description" id="description"><?php echo $this->company_type->description; ?></textarea>
	</fieldset>
</div>
...
<input type="hidden" name="cid[]" value="<?php echo $this->company_type->id; ?>" />
