...
class seminarmanModelatgroup extends JModelLegacy
{
    var $_id = null;
    ...
    function delete($cid = array())
    {
        if ( count( $cid ) ){
        	...
        	if ($relatedRecords > 0)
        	{
                JError::raiseWarning('ERROR_CODE', JText::sprintf('COM_SEMINARMAN_RELATED_N_RECORDS', $relatedRecords));
        		return false;
        	}
    ...
    function _initData()
    {
        ...
        if (empty($this->_data))
        {
            $atgroup = new stdClass();
            $atgroup->id = 0;
            $atgroup->title = null;
            $atgroup->alias = null;
            $atgroup->code = null;
            $atgroup->color = 'FFFFFF';
            $atgroup->description = null;
            $atgroup->date = null;
            $atgroup->hits = 0;
            $atgroup->published = 0;
            $atgroup->checked_out = 0;
            $atgroup->checked_out_time = 0;
            $atgroup->ordering = 0;
            $atgroup->archived = 0;
            $atgroup->approved = 0;
            $atgroup->params = null;
