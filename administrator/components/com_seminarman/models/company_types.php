...
class seminarmanModelcompany_types extends JModelLegacy
{
    var $_data = null;
    ...
    function __construct()
    {
        ...
        $limitstart = $mainframe->getUserStateFromRequest('com_seminarman' . '.sman_com_tps_limitstart', 'sman_com_tps_limitstart', 0, 'int');

        $limitstart = ($limit != 0 ? (floor($limitstart / $limit) * $limit) : 0);

        $this->setState('limit', $limit);
        $this->setState('sman_com_tps_limitstart', $limitstart);
    }
    ...
    function getData()
    {
        ...
        if (empty($this->_data))
        {
            ...
            $this->_data = $this->_getList($query, $this->getState('sman_com_tps_limitstart'), $this->getState('limit'));
        }
    ...
    function getPagination()
    {
        ...
        if (empty($this->_pagination))
        {
            ...
            $this->_pagination = new JPagination($this->getTotal(), $this->getState('sman_com_tps_limitstart'), $this->getState('limit'), 'sman_com_tps_');
        }
