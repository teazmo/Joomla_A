...
class SeminarmanModelCourseelement extends JModelLegacy
{
    ...
    function __construct()
    {
        ...
        $limitstart = $mainframe->getUserStateFromRequest('com_seminarman' . 'sman_course_els_limitstart', 'sman_course_els_limitstart', 0, 'int');

        $this->setState('limit', $limit);
        $this->setState('sman_course_els_limitstart', $limitstart);
    }
    ...
    function getData()
    {
        ...
        if (empty($this->_data))
        {
            ...
            $this->_data = $this->_getList($query, $this->getState('sman_course_els_limitstart'), $this->getState('limit'));
        }
    ...
    function getPagination()
    {
        ...
        if (empty($this->_pagination))
        {
            ...
            $this->_pagination = new JPagination($this->getTotal(), $this->getState('sman_course_els_limitstart'), $this->getState('limit'), 'sman_course_els_');
        }
