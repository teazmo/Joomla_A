...
class seminarmanControllerExperience_level extends seminarmanController
{
    ...
    function save()
    {
        ...
        {
        	$link = 'index.php?option=com_seminarman&controller=experience_level&task=edit&cid[]='.(int)$id;
        }
       	else
